...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "legacy-authority-inventory":
        ...
        plane = kernel.legacy_authority_plane(
            ...
            governor_required=disposition == "canonical_consumer",
            evidence_only=disposition == "evidence_adapter",
            consumer_of_governor=disposition == "canonical_consumer",
            ledger_required=disposition == "canonical_consumer",
